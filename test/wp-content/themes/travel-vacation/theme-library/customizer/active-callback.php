...
function travel_vacation_is_banner_slider_section_and_content_type_post_enabled( $control ) {
	$content_type = $control->manager->get_setting( 'travel_vacation_banner_slider_content_type' )->value();
	return ( travel_vacation_is_banner_slider_section_enabled( $control ) && ( 'post' === $content_type ) );
}
function travel_vacation_is_banner_slider_section_and_content_type_page_enabled( $control ) {
	$content_type = $control->manager->get_setting( 'travel_vacation_banner_slider_content_type' )->value();
	return ( travel_vacation_is_banner_slider_section_enabled( $control ) && ( 'page' === $content_type ) );
}
...
function travel_vacation_is_places_section_and_content_type_post_enabled( $control ) {
	$content_type = $control->manager->get_setting( 'travel_vacation_places_content_type' )->value();
	return ( travel_vacation_is_places_section_enabled( $control ) && ( 'post' === $content_type ) );
}
function travel_vacation_is_places_section_and_content_type_page_enabled( $control ) {
	$content_type = $control->manager->get_setting( 'travel_vacation_places_content_type' )->value();
	return ( travel_vacation_is_places_section_enabled( $control ) && ( 'page' === $content_type ) );
}