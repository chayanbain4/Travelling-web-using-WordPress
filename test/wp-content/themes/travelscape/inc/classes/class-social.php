...
class TravelScape_Social_Lists{
     ...
     * @return void
     */
    public function travelscape_lists_all_svgs( $social ){
        if( !$social ){
            return;
        }
        switch ( $social ) {
     ...
     * @return void
     */
    public function travelscape_all_social_icons(){
        $social_array = [ 
            [
                'key' => 'travelscape_facebook',
                'value' => ''
            ],
            [
                'key' => 'travelscape_twitter',
                'value' => ''
            ],
            [
                'key' => 'travelscape_instagram',
                'value' => ''
            ],
            [
                'key' => 'travelscape_pinterest',
                'value' => ''
            ],
            [
                'key' => 'travelscape_youtube',
                'value' => ''
            ],
            [
                'key' => 'travelscape_tiktok',
                'value' => ''
            ],
            [
                'key' => 'travelscape_linkedin',
                'value' => ''
            ],
            [
                'key' => 'travelscape_whatsapp',
                'value' => ''
            ],
            [
                'key' => 'travelscape_viber',
                'value' => ''
            ],
            [
                'key' => 'travelscape_telegram',
                'value' => ''
            ],
            [
                'key' => 'travelscape_tripadvisor',
                'value' => ''
            ]
        ];
        $social_icons = apply_filters( 'travelscape_social_icons', $social_array );
     ...
     * @return void
     */
    public function travelscape_social_links(){        
        $ed_social_media        = get_theme_mod( 'travelscape_social_media', '1' );
        $ed_social_media_newtab = get_theme_mod( 'travelscape_social_media_newtab', '1' );
        $list_social            = $this->travelscape_all_social_icons();   
		
        if( !empty($list_social) ){ ?>
				<div class="travelscape-social-media-wrap">
					<ul class="social-icons">
						<?php 
							foreach( $list_social as $key => $value ){
								$actualsocialkey = str_replace( 'travelscape_','',$key );
								if( !empty( $value )){
									?>
										<li>
										<a href="<?php if( isset( $value ) ) echo esc_url( $value ); ?>" target="<?php echo $ed_social_media_newtab ? '_blank': '_self'; ?>" rel="nofollow noopener">
											<?php echo wp_kses( $this->travelscape_lists_all_svgs( $actualsocialkey ), travelscape_get_kses_extended_ruleset() ); ?>
										</a>
									</li>  
									<?php 
								}
